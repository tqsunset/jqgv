var ganttData = [
	{
		id: 1, name: "공연 중", series: [
			{ name: "마리 앙투아네트", start: new Date(2021,06,13), end: new Date(2021,10, 03), custom: "hey"},
			{ name: "광화문 연가", start: new Date(2021, 06, 16), end: new Date(2021,08,05), color: "#f59595" },
			{ name: "드라큘라", start: new Date(2021, 04, 20), end: new Date(2021,07,01), color: "#88f199" },
			{ name: "비틀쥬스", start: new Date(2021, 04,20), end: new Date(2021,07,01), color: "#9584de" },
			{ name: "레드북", start: new Date(2021,05,04 ), end: new Date(2021,07,22), color: "#ca88e7" },
			{ name: "해적", start: new Date(2021,05,15 ), end: new Date(2021,07, 29), color: "#d4e392" }
	...
	// 		{ name: "Projected", start: new Date(2010,00,06), end: new Date(2010,00,17), color: "#e0e0e0" }메
	// 	]
	// },
	// {
